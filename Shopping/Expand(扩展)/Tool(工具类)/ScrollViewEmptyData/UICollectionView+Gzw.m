...
{
    objc_setAssociatedObject(self, &tableViewblock, loadingClick, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
-(void (^)())loadingClick
{
    return objc_getAssociatedObject(self, &tableViewblock);
}
